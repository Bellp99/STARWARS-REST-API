...
def setup_commands(app):
    ...
    def insert_test_users():
        ...
        user_list = ['johnmiracle90', 'samycarly', 'Vakenty']
    ...
    @app.cli.command("insert-test-people")
    ...
    def insert_test_planets():
        planet_name_list = ['Luke Skywalker', 'Darth Vader', 'C-3PO', 'Leah Organa', 'Obiwan Kenobi']
        planet_terrain_list = ['blonde', 'none', 'none', 'black', 'white']
